...
$users_page_link = add_query_arg( 'page', 'users', $dashboard );
...
<div class="block">
    <div class="block-verify">
        <div class="block-col block-col-33 text-left">
            ...
            <div><?php echo esc_attr($new_listings); ?> <?php echo $new_listings_text; ?></div>
        ...
        <div class="block-col block-col-33">
            ...
            <div><?php echo esc_attr($new_reservations); ?> <?php echo $new_reservations_text; ?></div>
        ...
        <div class="block-col block-col-33">
            ...
            <div><?php echo esc_attr($new_users); ?> <?php echo $new_users_text; ?></div>
