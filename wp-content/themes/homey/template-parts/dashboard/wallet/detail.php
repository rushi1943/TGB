    ...
    <div class="block-head">
        ...
        <div class="block-right">
            <div class="custom-actions">
                <button class="btn-action" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $homey_local['back_btn']?>" onclick="window.location.href='<?php echo esc_url($wallet_page_link); ?>'"> <i class="fa fa-mail-reply"></i></button>
            </div><!-- custom-actions -->
        </div><!-- block-right -->
    </div><!-- block-head -->
            ...
            <div class="block-right">
                <div class="payment-list earnings-detail-list">
                    <ul>
                        ...
                        <li class="sub-total"><?php esc_html_e('Sub Total', 'homey'); ?> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" aria-hidden="true"></i> <span><?php echo homey_formatted_price($chargeable_amount); ?></span></li>

                        <li class="sub-total"><?php echo esc_html__('Fees', 'homey'); ?> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" aria-hidden="true"></i></li>
                        ...
                        <li class="sub-total"><?php echo esc_html__('Net Earnings', 'homey'); ?> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" aria-hidden="true"></i></li>
