                            ...
                            <div class="block-head">
                                ...
                                <div class="block-right">
                                     <div class="custom-actions">
                                        <button class="btn-action" onclick="window.location.href='<?php echo esc_url($payouts_page_link); ?>'" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php esc_html_e('Back', 'homey'); ?>"><i class="fa fa-reply"></i></button>
                                    </div><!-- custom-actions -->
                                        ...
                                        <div class="payment-list">
                                            <ul class="list-unstyled list-lined">
                                                ...
                                                <li>
                                                    ...
                                                    <span><?php echo $price_prefix.' '.homey_formatted_price($total_amount); ?></span>
                                                </li>
                                    ...
                                    <div class="block-right">
                                        ...
                                        <ul class="list-unstyled list-lined">
                                            <li>
                                                ...
                                                <?php echo $ben->ben_street_address.', '.$ben->ben_city.', '.$ben->ben_state.', '.$ben->ben_zip_code; ?>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="list-unstyled list-lined mb-0">
                                            ...
                                            <?php } elseif ($payout_method == 'wire') { 
                                                ...
                                                <li>
                                                    ...
                                                    <?php echo $bankInfo->wir_street_address.', '.$bankInfo->wir_city.', '.$bankInfo->wir_state.', '.$bankInfo->wir_zip_code;?>
                                                </li>
                    ...
                    <div class="block">
                        <div class="block-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="payout_status" class="selectpicker" data-live-search="false" title="">
                            ...
                            <!-- <div class="form-group transfer_note">
                                <label><?php esc_html_e('Note', 'homey'); ?></label>
                            
                                <textarea class="form-control" name="transfer_note" id="transfer_note" placeholder="<?php esc_html_e('Enter note for host', 'homey'); ?>"><?php echo esc_attr($transfer_note); ?></textarea>
                            </div> -->
