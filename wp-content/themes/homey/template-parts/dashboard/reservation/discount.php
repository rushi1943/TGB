                            ...
                            <?php foreach($discount_meta as $discount) { ?>
                                <div class="imported-calendar-row clearfix">
                                    <div class="imported-calendar-50">
                                        <input type="text" name="discount_name[]" class="form-control discount_name" value="<?php echo $discount['discount_name']; ?>" readonly>
                                    </div>
                                    <div class="imported-calendar-50">
                                        <input type="text" name="discount_value[]" class="form-control discount_value" value="<?php echo $discount['discount_value']; ?>" readonly>
                                    </div>
