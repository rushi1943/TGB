...
<div id="information-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block">
        ...
        <div class="block-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="false" name="listing_address2" class="form-control" id="listing_address2" value="<?php homey_field_meta('listing_address2'); ?>"  placeholder="Address2">
                    </div>
                </div>                
                <?php } ?>
            ...
            <?php } ?>
                <?php //if($hide_fields['phone'] != 1) { ?>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input type="text" autocomplete="false" name="phone" value="<?php homey_field_meta('phone'); ?>" class="form-control" id="phone" placeholder="Phone">
                    </div>
                </div>
                <?php //} ?>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="false" name="url" class="form-control" id="url" value="<?php homey_field_meta('url'); ?>" placeholder="URL">
                    </div>
                </div>
                <?php //} ?>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <label class="control control--checkbox radio-tab">
                            <input name="list_more_guid" value="1" <?php checked( homey_get_field_meta('list_more_guid'), 1); ?> type="checkbox">
