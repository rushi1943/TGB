...
<div class="search-filter">
	...
	<div class="search-filter-wrap">
		...
		<?php 
		if($search_hide_fields['search_animals'] != 1) {
			get_template_part('template-parts/search/animals'); 
		}
		?>

		<?php 
		if($search_hide_fields['search_terrains'] != 1) {
			get_template_part('template-parts/search/terrains'); 
		}
		?>
