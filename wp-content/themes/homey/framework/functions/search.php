...
if( !function_exists('homey_listing_search') ) {
    function homey_listing_search($search_query)
    {
        ...
        if (isset($_GET['terrain']) && !empty($_GET['terrain'])) {
            if (is_array($_GET['terrain'])) {
                $terrains = $_GET['terrain'];
