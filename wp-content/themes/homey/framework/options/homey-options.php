...
Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            'id'       => 'srh_animals',
            'type'     => 'text',
            'title'    => $homey_local['search_animals'],
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['search_animals'],
        ),
        array(
            'id'       => 'srh_terrains',
            'type'     => 'text',
            'title'    => $homey_local['search_terrains'],
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['search_terrains'],
        ),
    )
));
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id'       => 'ad_listing_phone',
            'type'     => 'text',
            'title'    => esc_html__( 'Phone', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_phone']
        ),
        array(
            'id'       => 'ad_phone_plac',
            'type'     => 'text',
            'title'    => esc_html__( 'Phone Placeholder', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_phone_placeholder']
        ),

        array(
            'id'       => 'ad_listing_url',
            'type'     => 'text',
            'title'    => esc_html__( 'Url', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_url']
        ),
        array(
            'id'       => 'ad_url_plac',
            'type'     => 'text',
            'title'    => esc_html__( 'Url Placeholder', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_url_placeholder']
        ),

        array(
            'id'       => 'ad_listing_more_guid',
            'type'     => 'text',
            'title'    => esc_html__( 'More Guid', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_more_guid']
        ),

        array(
            'id'       => 'ad_listing_guid',
            'type'     => 'text',
            'title'    => esc_html__( 'Guides', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_guid']
        ),
        ...
        array(
            'id'       => 'ad_listing_price_all_date',
            'type'     => 'text',
            'title'    => esc_html__( 'Price stays the same for all dates', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_price_all_date']
        ),

        array(
            'id'       => 'ad_listing_run_deal',
            'type'     => 'text',
            'title'    => esc_html__( 'Run a deal on this trip', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_run_deal']
        ),


        array(
            'id'       => 'ad_listing_participants',
            'type'     => 'text',
            'title'    => esc_html__( 'Participants', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_participants']
        ),

        array(
            'id'       => 'ad_participants_plac',
            'type'     => 'text',
            'title'    => esc_html__( 'Participants Price Placeholder', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_participants_placeholder']
        ),

        array(
            'id'       => 'ad_listing_unlimited_participants',
            'type'     => 'text',
            'title'    => esc_html__( 'Unlimited Participants', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_unlimited_participants']
        ),
        ...
        array(
            ...
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_price']
        ),

        array(
            'id'       => 'ad_listing_price_plac',
            'type'     => 'text',
        ...
        array(
            'id'       => 'ad_listing_age_all',
            'type'     => 'text',
            'title'    => esc_html__( 'All Ages', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_age_all']
        ),

        array(
            'id'       => 'ad_listing_age_family_friendly',
            'type'     => 'text',
            'title'    => esc_html__( 'Family Friendly', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_age_family_friendly']
        ),


        array(
            'id'       => 'ad_listing_age_plac',
            'type'     => 'text',
            'title'    => esc_html__( 'Age Placeholder', 'homey' ),
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['listing_age_plac']
        ),
        ...
        array(
            'id'       => 'listing_loadge_label',
            'type'     => 'text',
            'title'    => esc_html__('Loadge', 'homey'),
            'desc'     => '',
            'subtitle' => '',
            'default' => 'Does this trip include lodging?',
        ),
        ...
        array(
            'id'       => 'ad_animals',
            'type'     => 'text',
            'title'    => $homey_local['animals'],
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['animals']
        ),
        array(
            'id'       => 'ad_terrains',
            'type'     => 'text',
            'title'    => $homey_local['terrains'],
            'desc'     => '',
            'subtitle' => '',
            'default' => $homey_local['terrains']
        ),
    ...
    'fields'        => array(
        ...
        array(
            ...
            'options'  => array(
                ...
                'search_animals' => $homey_local['search_animals'],
                'search_terrains' => $homey_local['search_terrains'],
...
$submit_form_fields = array(
    ...
    'animals' => $homey_local['animals'],
    'terrains' => $homey_local['terrains'],
    'listing_address' => $homey_local['address'],
    'listing_address2' => $homey_local['address2'],
    ...
    'listing_phone' => $homey_local['listing_phone'],
    'listing_url' => $homey_local['listing_url'],
    'listing_more_guid' => $homey_local['listing_more_guid'],
    'listing_guid' => $homey_local['listing_guid'],
    'listing_price_all_date' => $homey_local['listing_price_all_date'],
    'listing_run_deal' => $homey_local['listing_run_deal'],
    'listing_participants' => $homey_local['listing_participants'],
    'listing_unlimited_participants' => $homey_local['listing_unlimited_participants'],
    //'listing_price_placeholder' => $homey_local['listing_price_placeholder'],
    'listing_price' => $homey_local['listing_price'],
    'listing_age_all' => $homey_local['listing_age_all'],
    'listing_age_family_friendly' => $homey_local['listing_age_family_friendly'],
    'listing_age_plac' => $homey_local['listing_age_plac'],
