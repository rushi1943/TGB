...
if( !function_exists( 'homey_register_metaboxes' ) ) {
    function homey_register_metaboxes() {
        ...
        * ============================================================================================*/
        $meta_boxes[] = array(
            ...
            'fields' => array(
                ...
                array(
                    'id' => "{$prefix}listing_phone",
                    'name' => homey_option('ad_listing_phone'),
                    'placeholder' => homey_option('ad_listing_phone_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_details',
                ...
                array(
                    ...
                    'name' => homey_option('ad_listing_url'),
                    'placeholder' => homey_option('ad_listing_url_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_details',
                ...
                array(
                    'id' => "{$prefix}listing_more_guid",
                    'name' => homey_option('ad_listing_more_guid'),
                    'placeholder' => homey_option('ad_listing_more_guid_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_details',
                ...
                **-------------------------------------------------------------------------------*/
                ...
                array(
                    'id' => "{$prefix}listing_price_all_date",
                    'name' => homey_option('listing_price_all_date'),
                    'type' => 'checkbox',
                    'columns' => 3,
                    'default'  => '0',
                    'tab' => 'listing_price',
                ...
                array(
                    'id' => "{$prefix}listing_run_deal",
                    'name' => homey_option('listing_run_deal'),
                    'type' => 'checkbox',
                    'columns' => 3,
                    'default'  => '0',
                    'tab' => 'listing_price',
                ...
                array(
                    'id' => "{$prefix}listing_participants",
                    'name' => homey_option('listing_participants'),
                    'type' => 'text',
                    'tab' => 'listing_price',
                ),

                array(
                    'id' => "{$prefix}listing_unlimited_participants",
                    'name' => homey_option('listing_unlimited_participants'),
                    'type' => 'text',
                    'tab' => 'listing_price',
                ),
                array(
                    'id' => "{$prefix}listing_loadge_description",
                    'name' => homey_option('listing_loadge_description'),
                    'type' => 'text',
                    'tab' => 'listing_price',
                ),
                array(
                    'id' => "{$prefix}listing_price",
                    'name' => homey_option('listing_price'),
                    'type' => 'text',
                    'tab' => 'listing_price',
                ),

                array(
                    'id' => "{$prefix}listing_age_all",
                    'name' => "listing_age_all",
                    'type' => 'checkbox',
                    'columns' => 3,
                    'default'  => '0',
                    'tab' => 'listing_price',
                ...
                array(
                    'id' => "{$prefix}listing_age_family_friendly",
                    'name' => "listing_age_family_friendly",
                    'type' => 'checkbox',
                    'columns' => 3,
                    'default'  => '0',
                    'tab' => 'listing_price',
                ...
                **-------------------------------------------------------------------------------*/
                ...
                array(
                    'id' => "{$prefix}listing_address2",
                    'name' => homey_option('ad_address2'),
                    'placeholder' => homey_option('ad_address2_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_location',
                ...
                array(
                    'id' => "{$prefix}url",
                    'name' => homey_option('ad_url'),
                    'placeholder' => homey_option('ad_url_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_location',
                ...
                array(
                    'id' => "{$prefix}list_more_guid",
                    'name' => homey_option('ad_list_more_guid'),
                    'placeholder' => homey_option('ad_list_more_guid_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_location',
                ...
                array(
                    'id' => "{$prefix}listing_guid",
                    'name' => homey_option('ad_listing_guid'),
                    'placeholder' => homey_option('ad_listing_guid_placeholder'),
                    'type' => 'text',
                    'std' => '',
                    'columns' => 12,
                    'tab' => 'listing_location',
        ...
        * ============================================================================================*/
        $listing_types = array();
        $room_types = array();
        $listing_animal = array();
        $listing_terrain = array();
        ...
        homey_get_terms_array( 'listing_animal', $listing_animal );
        homey_get_terms_array( 'listing_terrain', $listing_terrain );
        ...
        $meta_boxes[] = array(
            ...
            'fields'    => array(
                ...
                array(
                    'name'      => esc_html__('animals', 'homey'),
                    'id'        => $prefix . 'animals',
                    'type'      => 'select',
                    'options'   => $listing_animal,
                    'desc'      => '',
                    'columns' => 6,
                    'multiple' => true
                ),
                array(
                    'name'      => esc_html__('terrains', 'homey'),
                    'id'        => $prefix . 'terrains',
                    'type'      => 'select',
                    'options'   => $listing_terrain,
                    'desc'      => '',
                    'columns' => 6,
                    'multiple' => true
                ),
