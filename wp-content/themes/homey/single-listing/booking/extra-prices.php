		    ...
		    foreach($extra_prices as $key => $option) { ?>
		    	<li>
					<label class="homey_extra_price control control--checkbox">
						<input type="checkbox" name="extra_price[]" data-name="<?php echo esc_attr($option['name']); ?>" data-price="<?php echo $option['price']; ?>" data-type="<?php echo esc_attr($option['type']); ?>">
