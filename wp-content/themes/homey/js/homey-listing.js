jQuery(document).ready( function($) {
    ...
    if ( typeof Homey_Listing !== "undefined" ) {
        ...
        *---------------------------------------------------------------------------*/
        ...
        if (document.getElementById('listing_address2')) {
            var inputField, defaultBounds, autocomplete;
            inputField = (document.getElementById('listing_address2'));
            defaultBounds = new google.maps.LatLngBounds(
                new google.maps.LatLng(-90, -180),
                new google.maps.LatLng(90, 180)
            );
        ...
        function animals_selector(ele, view_ele, is_text) {
        ...
        animals_selector("#listing_type", "#listing-type-view", 'yes');
