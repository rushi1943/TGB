...
"use strict";
    ...
    if ( typeof HOMEY_map_vars !== "undefined" ) {
        ...
        var area = HOMEY_map_vars.area;
        var animal = HOMEY_map_vars.animal;
        var terrain = HOMEY_map_vars.terrain;
        ...
        *-------------------------------------------------------------------------------------*/
        ...
        var homey_make_search_call = function(current_form, current_page, _lat, _long, element, markerTarget, showMarkerLabels, defaultZoom, optimizedMapLoading, isHalfMap) {
            ...
            animal = current_form.find('.animals-list input[type=checkbox]:checked').map(function(_, el) {
                return $(el).val();
            }).toArray();

            terrain = current_form.find('.terrains-list input[type=checkbox]:checked').map(function(_, el) {
                return $(el).val();
            }).toArray();
