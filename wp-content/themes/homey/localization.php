...
if( !function_exists('homey_get_localization')) {
	function homey_get_localization() {
		...
		$localization = array(
			...
			'animals' => esc_html__('animals', 'homey'),
			'terrains' => esc_html__('terrains', 'homey'),
			...
			'address2' => esc_html__('Address', 'homey'),

			'listing_phone' => esc_html__('Phone', 'homey'),
			'listing_phone_placeholder' => esc_html__('Enter the Phone Number', 'homey'),


			'listing_url' => esc_html__('URL', 'homey'),
			'listing_url_placeholder' => esc_html__('Enter the url Number', 'homey'),

			'listing_more_guid' => esc_html__('More Guid', 'homey'),
			'listing_guid' => esc_html__('Guid', 'homey'),

			'listing_price_all_date' => esc_html__('Price stays the same for all dates', 'homey'),
			'listing_run_deal' => esc_html__('Run a deal on this trip', 'homey'),
			'listing_participants' => esc_html__('Participants', 'homey'),
			'listing_unlimited_participants' => esc_html__('Unlimited Participants', 'homey'),
			'listing_participants_placeholder' => esc_html__('$ 0.00', 'homey'),

			'listing_price' => esc_html__('Price', 'homey'),
			'listing_price_placeholder ' => esc_html__('$ 0.00', 'homey'),

			'listing_age_all' => esc_html__('All Ages', 'homey'),
			'listing_age_family_friendly' => esc_html__('Age Family Friendly', 'homey'),
			'listing_age_plac' => esc_html__('18+', 'homey'),
			...
			*------------------------------------------------------*/
			...
			'search_animals' => esc_html__('animals', 'homey' ),
			'search_terrains' => esc_html__('terrains', 'homey' ),
