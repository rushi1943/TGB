                ...
                <div class="compare-table">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                            $all_animals = get_terms( array( 'taxonomy' => 'listing_animal', 'fields' => 'names' ) );
                            $compare_terms = array();

                            foreach ( $ids as $post_ID ) :

                            $compare_terms[ $post_ID ] = wp_get_post_terms( $post_ID, 'listing_animal', array( 'fields' => 'names' ) );

                            endforeach;

                            foreach ( $all_animals as $data ) :
