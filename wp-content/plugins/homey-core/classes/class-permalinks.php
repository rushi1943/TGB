...
class Homey_Permalinks {
    ...
    public static function homey_register_settings() {
        ...
        add_settings_field( 'listing_category_rewrite_base',   esc_html__( 'Listing Category',   'homey-core' ), array( __CLASS__, 'listing_category_rewrite_base'), 'homey_permalinks', 'permalinks' );
        ...
        add_settings_field( 'listing_animal_rewrite_base',   esc_html__( 'Amenity',   'homey-core' ), array( __CLASS__, 'animal_callback'   ), 'homey_permalinks', 'permalinks' );

        add_settings_field( 'listing_terrain_rewrite_base',   esc_html__( 'terrain',   'homey-core' ), array( __CLASS__, 'terrain_callback'   ), 'homey_permalinks', 'permalinks' );

        add_settings_field( 'listing_weapon_rewrite_base',   esc_html__( 'weapon',   'homey-core' ), array( __CLASS__, 'weapon_callback'   ), 'homey_permalinks', 'permalinks' );
    ...
    public static function homey_validate_settings( $settings ) {
        ...
        $settings['listing_category_rewrite_base'] = $settings['listing_category_rewrite_base'] ? trim( strip_tags( $settings['listing_category_rewrite_base']   ), '/' ) : '';
        ...
        $settings['listing_animal_rewrite_base'] = $settings['listing_animal_rewrite_base'] ? trim( strip_tags( $settings['listing_animal_rewrite_base']   ), '/' ) : '';
        $settings['listing_weapon_rewrite_base'] = $settings['listing_weapon_rewrite_base'] ? trim( strip_tags( $settings['listing_weapon_rewrite_base']   ), '/' ) : '';        
     ...
     * @return void
     */
    public static function listing_category_callback() { ?>

        <label>
            <code><?php echo esc_url( home_url( '/' ) ); ?></code>
            <input type="text" class="regular-text code" name="homey_settings[listing_category_rewrite_base]" value="<?php echo esc_attr( homey_get_listing_categry_rewrite_base() ); ?>" />
        </label>
     ...
     * @return void
     */
    public static function listing_transport_callback() { ?>

        <label>
            <code><?php echo esc_url( home_url( '/' ) ); ?></code>
            <input type="text" class="regular-text code" name="homey_settings[listing_transport_rewrite_base]" value="<?php echo esc_attr( homey_get_listing_transport_rewrite_base() ); ?>" />
        </label>
     ...
     * @return void
     */
    public static function animal_callback() { ?>

        <label>
            <code><?php echo esc_url( home_url( '/' ) ); ?></code>
            <input type="text" class="regular-text code" name="homey_settings[animal_rewrite_base]" value="<?php echo esc_attr( homey_get_animal_rewrite_base() ); ?>" />
        </label>
     ...
     * @return void
     */
    public static function terrain_callback() { ?>

        <label>
            <code><?php echo esc_url( home_url( '/' ) ); ?></code>
            <input type="text" class="regular-text code" name="homey_settings[terrain_rewrite_base]" value="<?php echo esc_attr( homey_get_terrain_rewrite_base() ); ?>" />
        </label>
     ...
     * @return void
     */
    public static function weapon_callback() { ?>

        <label>
            <code><?php echo esc_url( home_url( '/' ) ); ?></code>
            <input type="text" class="regular-text code" name="homey_settings[weapon_rewrite_base]" value="<?php echo esc_attr( homey_get_weapon_rewrite_base() ); ?>" />
        </label>
